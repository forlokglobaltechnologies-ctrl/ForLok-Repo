...
API_BASE_URL=http://10.170.142.16:3000
FRONTEND_URL=http://10.170.142.16:19006
...
- ✅ Start on http://10.170.142.16:3000

## Test the Server

1. **Health Check:**
   ```
   GET http://10.170.142.16:3000/health
   ```

2. **API Info:**
   ```
   GET http://10.170.142.16:3000/
   ```

## Connect Mobile App

### For Emulator/Simulator:
- Use: `http://10.170.142.16:3000`
...
1. Find your computer's IP address:
   ...
   # Windows
   ipconfig
   # Look for IPv4 Address (e.g., 10.170.142.16)
...
2. Update `mobile-app/src/config/api.ts`:
   ...
   const API_BASE_URL = __DEV__
    ? 'http://10.170.142.16:3000' // Your IP address
...
1. ✅ Server running on http://10.170.142.16:3000
